<?php
require 'db.php';
$sql = 'SELECT * FROM producto ORDER BY Unid_disp';
...
<div class="container">
  <div class="card mt-5">
    <div class="card-header">
      <h2>Productos</h2>
	  <p>Cantidad</p>
	  <form name="form1" method="POST" action="Casc.php">
		<button type="submit" name="ascendente" value="Ascendente">
		</form>
		
		<form name="form1" method="POST" action="Cdsc.php">
		<button type="submit" name="aescendente" value="Descendente">
		</form>
    </div>
    <div class="card-body">
