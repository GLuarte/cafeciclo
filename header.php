...
@media screen and (max-height: 450px) {
  ...
  <div id="mySidenav" class="sidenav" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
